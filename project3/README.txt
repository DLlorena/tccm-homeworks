...
Inside the code you will find comments along the file explaining how we did the projet.
...
It will generate an output fille named: "outputDYH_DLP.xyz". It does not show anything on the terminal, all the info will be in the outuput file!!
