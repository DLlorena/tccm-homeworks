...
If the directory path needs to be modified, it could be done by changing variable "molecules_directory" in line 60 in "Project1_DYH_DLP.c". Defined as default as "./data/".
...
Program also gives the possibility of displaying in terminal specific two electron integrals. The lines to do it remain commented as default between 310-319 lines. Indexes i, j, k, l have to be initialized (i=1, j=2 , k=3, l=4 as default).
